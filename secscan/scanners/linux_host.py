...
class LinuxHostScanner(Scanner):
    ...
    def capability(self) -> ScannerCapability:
        return ScannerCapability(
            name="linux-host",
            description="authenticated Linux host posture assessment over key-based SSH",
    ...
    def scan(self, request: ScanRequest) -> ScanResult:
        ...
        values = _parse_output(completed.stdout)
        ...
        return ScanResult(
            ...
            scanner={"name": "secscan-linux-host", "version": "ssh-posture-v1"},
        )
