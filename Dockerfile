...
RUN python -c "from pathlib import Path; required={'secscan/__init__.py','secscan/auth.py','secscan/aws.py','secscan/billing.py','secscan/cli.py','secscan/compare.py','secscan/history.py','secscan/models.py','secscan/normalize.py','secscan/policy.py','secscan/public_site.py','secscan/report.py','secscan/signed_policy.py','secscan/ssh_credentials.py','secscan/ssh_host_trust.py','secscan/ssh_host_trust_web.py','secscan/tenancy.py','secscan/trivy.py','secscan/web.py','secscan/windows_host_web.py','secscan/web_assets/__init__.py','secscan/web_assets/index.html','secscan/web_assets/ssh_credentials.js','secscan/web_assets/windows_host.js','secscan/scanners/__init__.py','secscan/scanners/base.py','secscan/scanners/registry.py','secscan/scanners/grype.py','secscan/scanners/image.py','secscan/scanners/filesystem.py','secscan/scanners/repository.py','secscan/scanners/full_repository.py','secscan/scanners/network.py','secscan/scanners/linux_host.py','secscan/scanners/sbom.py'}; missing={path for path in required if not Path(path).is_file()}; assert not missing, f'missing source modules: {sorted(missing)}'; print('verified source tree:', ', '.join(sorted(required)))" \
...
RUN pip install --no-cache-dir /wheels/secscan-*.whl \
    && python -c "import paramiko, secscan, secscan.auth, secscan.aws, secscan.billing, secscan.cli, secscan.compare, secscan.history, secscan.models, secscan.normalize, secscan.policy, secscan.public_site, secscan.report, secscan.signed_policy, secscan.ssh_credentials, secscan.ssh_host_trust, secscan.ssh_host_trust_web, secscan.tenancy, secscan.trivy, secscan.windows_host_web, secscan.scanners, secscan.scanners.base, secscan.scanners.registry, secscan.scanners.grype, secscan.scanners.image, secscan.scanners.filesystem, secscan.scanners.repository, secscan.scanners.full_repository, secscan.scanners.network, secscan.scanners.linux_host, secscan.scanners.sbom" \
    && rm -rf /wheels
