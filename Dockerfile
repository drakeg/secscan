...
RUN pip install --no-cache-dir /wheels/secscan-*.whl \
    && python -c "import secscan, secscan.cli, secscan.compare, secscan.models, secscan.normalize, secscan.policy, secscan.report, secscan.trivy, secscan.scanners, secscan.scanners.base, secscan.scanners.registry, secscan.scanners.image, secscan.scanners.filesystem" \
    && rm -rf /wheels \
