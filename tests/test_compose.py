...
def test_local_compose_service_keeps_secure_persistent_defaults() -> None:
    ...
    assert service["environment"] == {
        ...
        "SECSCAN_STRIPE_SECRET_KEY": "${SECSCAN_STRIPE_SECRET_KEY:-}",
        "SECSCAN_STRIPE_WEBHOOK_SECRET": "${SECSCAN_STRIPE_WEBHOOK_SECRET:-}",
        "SECSCAN_STRIPE_PROFESSIONAL_PRICE_ID": "${SECSCAN_STRIPE_PROFESSIONAL_PRICE_ID:-}",
        "SECSCAN_PUBLIC_BASE_URL": "${SECSCAN_PUBLIC_BASE_URL:-}",
